...
Route::middleware(['web','auth', \App\Http\Middleware\EnsureRole::class . ':org'])->prefix('org')->as('org.')->group(function () {
...
Route::middleware(['web','auth', \App\Http\Middleware\EnsureRole::class . ':org'])
    ->prefix('org')
    ->group(function () {
