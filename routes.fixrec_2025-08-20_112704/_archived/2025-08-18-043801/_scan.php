...
Route::middleware(['web','auth'])->group(function () {
    ...
    Route::post('/scan/checkin',      [QrAttendanceController::class, 'checkin'])->name('scan.checkin');
    Route::post('/scan/checkout',     [QrAttendanceController::class, 'checkout'])->name('scan.checkout');
